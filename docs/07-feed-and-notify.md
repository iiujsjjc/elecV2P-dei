...
地址为网页端口（默认为 80） + /feed 例如：[http://127.0.0.1/feed](http://127.0.0.1/feed)
...
2. 在 ifttt 中搜索 webhook，或访问 [https://ifttt.com/maker\_webhooks/](https://ifttt.com/maker_webhooks/) ，添加 webhook 服务
...
1. 在 ifttt 的 webhook setting edit 中找到对应的 **key**, 然后把 key 填写到 webUI 后台管理页面的 setting 对应位置
...
\`\`\` JS example $feed.push\('elecV2P notification', '这是一条来自 elecV2P 的通知', '[https://github.com/elecV2/elecV2P](https://github.com/elecV2/elecV2P)'\)
